...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $documents = User::join('personal_tables','personal_tables.user_id','users.id')->where('notification',1)->get();
        ...
        return view('pages.dashboard', compact('users','anniversary', 'birthday', 'totalApsensys', 'trainingApsensys', 'permanentApsensys', 'noticeApsensys', 'inactiveApsensys', 'totalTSR', 'trainingTSR', 'permanentTSR', 'noticeTSR', 'inactiveTSR', 'totalCB', 'trainingCB', 'permanentCB', 'noticeCB', 'inactiveCB', 'announcements', 'documents'));
    }
