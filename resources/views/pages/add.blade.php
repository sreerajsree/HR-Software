            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <textarea name="temp_address_1" cols="30" rows="10" class="form-control"
                                    placeholder="Address Line 1" required></textarea>
                            </div>
                            <div class="col">
                                <textarea name="temp_address_2" cols="30" rows="10" class="form-control"
                                    placeholder="Address Line 2" required></textarea>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col">
                            ...
                            <div class="col">
                                <input type="number" class="form-control" placeholder="Pincode" name="temp_pincode"
                                    aria-label="Pincode" required pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==6) return false;"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <textarea name="perm_address_1" cols="30" rows="10" class="form-control"
                                    placeholder="Address Line 1" required></textarea>
                            </div>
                            <div class="col">
                                <textarea name="perm_address_2" cols="30" rows="10" class="form-control"
                                    placeholder="Address Line 2" required></textarea>
                            </div>
                        </div>
                        <div class="row mt-5">
                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Education" aria-label="Education"
                    ...
                    <div class="card-body">
                        <div class="row mt-3">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Pan Card" aria-label="Pan Card"
                            ...
                            <div class="col">
                                <input type="text" class="form-control" placeholder="UAN Number" aria-label="UAN Number"
                                    name="uan" required>
                            </div>
                        </div>
                        <div class="row mt-5">
                            <div class="col">
                                <input type="text" class="form-control" placeholder="Bank Name" aria-label="Bank Name"
                            ...
                            <div class="col">
                                <input type="text" class="form-control" placeholder="IFSC Code" aria-label="IFSC Code"
                                    name="ifsc" required>
                            </div>
                        </div>
                        <div class="row mt-5">
