...
@section('content')
<img src="assets/img/banner.jpg" alt="HR Soft Banner Images" class="mb-5">
@if (Auth::User()->status == 1 &&
Auth::User()->add_status == 1 &&
Carbon\Carbon::parse($users->dob)->format('d-m') == Carbon\Carbon::now()->format('d-m'))
            ...
            <div id="nav-tab" role="tablist">
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <a class="nav-link active" id="nav-home-tab" data-coreui-toggle="tab" data-coreui-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="nav-link" id="nav-profile-tab" data-coreui-toggle="tab" data-coreui-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">
                            <div class="card mb-4 p-5 cardhover">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="nav-link" id="nav-contact-tab" data-coreui-toggle="tab" data-coreui-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">
                            <div class="card mb-4 p-5 cardhover">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="ticker">
                        ...
                        <div class="news">
                            <marquee class="news-content" onmouseover="this.stop();" onmouseout="this.start();">
                                ...
                                <p> <svg class="icon">
                                        <use xlink:href="/vendors/@coreui/icons/svg/free.svg#cil-bell"></use>
                                    </svg> <a href="/edit-employee/{{ encrypt($dc->id) }}">{{ $dc->name }} updated the details</a>
                                </p>
                                @endforeach
                            </marquee>
                        </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4">
                                    <img src="/ProfileImages/{{ Auth::user()->profile_pic }}" alt="Profile Picture" class="rounded-circle mt-2" width="150" height="150" style="object-fit: cover">
                                </div>
                                <div class="col-4">
                                    <table class="table">
                                        <tr>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="p-3">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th scope="col">Website</th>
                                                    <th><a target="blank" href="https://thesiliconreview.com/">www.thesiliconreview.com</a>
                                                    </th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th scope="col">E-Mail</th>
                                                    <th><a href="mailto:hr@thesiliconreview.com">hr@thesiliconreview.com</a>
                                                    </th>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="p-3">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th scope="col">Website</th>
                                                    <th><a target="blank" href="https://ciobulletin.com/">www.ciobulletin.com</a>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th scope="col">US Address</th>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ \Carbon\Carbon::parse($item->dob)->format('d-M-Y') }}
                                                                </td>
                                                            </tr>
                                                            @endif
                                                            @endforeach
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ \Carbon\Carbon::parse($item->joined_on)->format('d-M-Y') }}
                                                            </td>
                                                            <td>@php
