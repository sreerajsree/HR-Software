                            ...
                            <form action="{{ route('update.employee', $employee->id) }}" method="POST">
                                ...
                                @if (Auth::user()->status == 0)
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3 row">
                                                <label for="empcode" class="col-sm-2 col-form-label">Emp Code</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" placeholder="empcode"
                                                        value="{{ $employee->empcode }}" aria-label="Employee Id"
                                                        name="empcode">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" placeholder="Manager"
                                                        value="{{ $employee->manager }}" aria-label="Manager"
                                                        name="manager">
                                                    <span class="text-danger">* to be filled by HR</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                <label for="joined_on" class="col-sm-2 col-form-label">Joined On</label>
                                                <div class="col-sm-10">
                                                    <input type="date" class="form-control" placeholder="Joining date"
                                                        value="{{ $employee->joined_on }}" aria-label="joined_on"
                                                        name="joined_on">
                                                    <span class="text-danger">* to be filled by HR</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" placeholder="Esic No"
                                                        value="{{ $employee->esic_no }}" aria-label="esic_no"
                                                        name="esic_no">
                                                    <span class="text-danger">to be filled by HR</span>
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="empstatus" class="col-sm-2 col-form-label">Employee
                                                    Status</label>
                                                <div class="col-sm-10">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col">
                                        <label for="emernumber">Emergency Contact Number</label>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <textarea name="temp_address_1" id="temp_address_1" class="form-control" required>{{ $employee->temp_address_1 }}</textarea>
                                </div>
                                <div class="col">
                                    <label for="emername">Address 2</label>
                                    <textarea name="temp_address_2" id="temp_address_2" class="form-control" required>{{ $employee->temp_address_2 }}</textarea>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" value="{{ $employee->temp_pincode }}"
                                        name="temp_pincode" aria-label="Pincode" required pattern="/^-?\d+\.?\d*$/"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <textarea name="perm_address_1" id="perm_address_1" class="form-control" required>{{ $employee->perm_address_1 }}</textarea>
                                </div>
                                <div class="col">
                                    <label for="perm_address_2">Address 2</label>
                                    <textarea name="perm_address_2" id="perm_address_2" class="form-control" required>{{ $employee->perm_address_2 }}</textarea>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" value="{{ $employee->perm_pincode }}"
                                        name="perm_pincode" aria-label="Pincode" required pattern="/^-?\d+\.?\d*$/"
                        ...
                        <div class="card-body">
                            <div class="row mt-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" value="{{ $employee->yop }}"
