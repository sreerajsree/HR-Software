                                ...
                                @if (Auth::user()->status == 0)
                                    <div class="row mt-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $employee->ctc * (45 / 100) }}" name="basic_da" id="basic_da">
                                        </div>
                                        <div class="col">
                                            <label class="fw-bold mb-2" for="">HRA @ 20%</label>
                                            <input type="text" class="form-control" value="{{ $employee->ctc * (20 / 100) }}"
                                                name="fixed_hra" id="fixed_hra">
                                        </div>
                                        <div class="col">
                                            <label class="fw-bold mb-2" for="">Medical @12.2%</label>
                                            <input type="text" class="form-control"
                                                value="{{ $employee->ctc * (12.2 / 100) }}" name="fixed_med_allowance"
                                                id="fixed_med_allowance">
                                        </div>
                                        <div class="col">
                                            <label class="fw-bold mb-2" for="">Conveyance @ 12%</label>
                                            <input type="text" class="form-control"
                                                value="{{ $employee->ctc * (12 / 100) }}" name="fixed_conveyance"
                                                id="fixed_conveyance">
                                        </div>
                                        <div class="col">
                                            <label class="fw-bold mb-2" for="">EPF @10.8%</label>
                                            <input type="text" class="form-control" value="{{ $employee->ctc * (10.8 / 100) }}"
                                                name="fixed_epf" id="fixed_epf">
                                        </div>
                                        <div class="col">
                                            <label class="fw-bold mb-2" for="">CTC</label>
                                            <input type="text" class="form-control" value="{{ $employee->ctc }}"
                                                name="fixed_ctc" id="fixed_ctc">
                                        </div>
                                        <div class="col">
                                            <label class="fw-bold mb-2" for="">Shift Allowance</label>
                                            <input type="text" class="form-control"
                                                value="{{ $employee->shift_allowance }}" name="shift_allowance"
                                                id="shift_allowance">
                                        </div>
                                        <div class="col">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" value="{{ $employee->others }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="@if ($employee->earned_epf == 0) {{ 0 }}@else{{ $employee->last_epf }} @endif"
                                                    name="last_epf" id="last_epf">
                                            </div>
                                            <div class="col">
                                                <label class="fw-bold mb-2 text-danger" for="">Govt Admin
                                                    Charges</label>
                                                <input type="text" class="form-control"
                                                    value="@if ($employee->earned_epf == 0) {{ 0 }}@else{{ $employee->govt_charges }} @endif"
                                                    name="govt_charges" id="govt_charges">
                                            </div>
                                            <div class="col">
    ...
    <script>
        $(document).ready(function() {
            $(".calculate").click(function() {
                ...
                var total_deductions = last_esic + last_epf + govt_charges + professional_tax + parseInt(
                    special_deductions);
