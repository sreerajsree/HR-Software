                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <a class="nav-link" id="nav-joined-tab" data-coreui-toggle="tab"
                                data-coreui-target="#nav-joined" type="button" role="tab" aria-controls="nav-joined"
                                aria-selected="false">
                                <div class="card mb-5 py-5 cardhover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="dateofInterview{{ $req->id }}" tabindex="-1"
                                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Add Date
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST"
                                                                    ...
                                                                    <div class="input-group mb-3"><span
                                                                        ...
                                                                        <input placeholder="Date" id="date_of_interview"
                                                                            type="date"
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-primary text-white"
                                                    data-coreui-toggle="modal" data-coreui-target="#dateofInterview">Add
                                                    Team</button>
                                                @else
                                                {{ $req->team }}
                                                @endif
                                            ...
                                            <td>
                                                @if ($req->status == 1)
                                                <div class="dropdown">
                                                    <button class="btn btn-sm text-white btn-success dropdown-toggle"
                                                        type="button" data-coreui-toggle="dropdown"
                                                        aria-expanded="false">
                                                        Scheduled
                                                    </button>
                                ...
                                <table class="table table-striped table-bordered" id="example3" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $req->name }}</td>
                                            <td>{{ $req->comments }}</td>
                                            <td>@if($req->resume != null) <a class="btn btn-sm btn-primary text-white"
                                                    href="/Resumes/{{ $req->resume }}" download>{{ $req->resume }} <svg
                                                        class="icon">
                                                        <use
                                                ...
                                                <div class="modal fade" id="addComments{{ $req->id }}" tabindex="-1"
                                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST"
                                                                    ...
                                                                    <div class="input-group mb-3"><span
                                                                        ...
                                                                        <input placeholder="File" id="resume"
                                                                            type="file"
                                                                            class="form-control @error('resume') is-invalid @enderror"
                                                                            name="resume" value="{{ $req->resume }}"
                                                                            required autocomplete="resume" autofocus>
                                                                        @error('resume')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                                    ...
                                                                    <div class="input-group mb-3"><span
                                                                        ...
                                                                        <input placeholder="Comments" id="comments"
                                                                            type="text"
                                                                            class="form-control @error('comments') is-invalid @enderror"
                                                                            name="comments" value="{{ $req->comments }}"
                                                                            required autocomplete="comments" autofocus>
                                                                        @error('comments')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
