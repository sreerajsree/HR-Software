                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body p-5">
                            <form action="{{ route('leave.request') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <select name="leave_type" id="" class="form-control" required>
                                            ...
                                            @if ($takenleaves < 10 && (\today()->format('M') != 'Jun' || \today()->format('M') != 'Dec'))
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <textarea name="leave_reason" id="" cols="30" rows="5" class="form-control" placeholder="Reason"
                                            required></textarea>
                                    </div>
                                </div>
...
@section('scripts')
    <script>
        ...
        let Total_Days, Total_Leave, No_of_holidays = 0,
            loss_Leave = 0;
            ...
            if (start_date != undefined && end_date != undefined) {
                ...
                if (Total_Days > 0) {
                    if (SandwichLeave(Total_Days)) {
                        ...
                        while (i != Total_Days) {
                            orgleave_end_date =
                                `${Day_after_start_day.getFullYear()}-${(Day_after_start_day.getMonth())+1}-${Day_after_start_day.getDate()}`;
